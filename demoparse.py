...
class baseparser(HyperOptArgumentParser):
    def __init__(self,*args,strategy="random_search",**kwargs):
        ...
        self.opt_list("--test_eps", default=1/255, type=float,options=[1/255,2/255,4/255], tunable=False)
        self.opt_list("--test_numsteps", default=5, type=int, tunable=False)
        self.opt_list("--test_stepsize", default=1/255, options=[1/255,2/255,4/255], type=float, tunable=False)
